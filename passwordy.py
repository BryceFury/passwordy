...
from PyQt5.QtWidgets import QApplication, QCheckBox, QComboBox, QDesktopWidget, QFormLayout, QGridLayout, QHBoxLayout, QInputDialog, QLabel, QLineEdit, QMessageBox, QTabWidget, QPushButton, QRadioButton, QSizePolicy, QSpinBox, QTextEdit, QVBoxLayout, QWidget
